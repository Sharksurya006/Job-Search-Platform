...
const Overview = (job) => {
  ...
  return (
	<div>
		<div className="w-full border-1 mx-[10px] border-gray-400 p-6 flex flex-col gap-16 rounded-lg hover:shadow-[0_0_5px_1px_green]">
				<div className="flex justify-between px-[5px] items-center">
					<div className="flex items-center gap-6 pt-[20px]">
					 ...
					 <div className="flex flex-col gap-2 items-center">
						<div>
							<Link to="/apply-jobs">
							<button className="px-3 py-2 bg-green-500 rounded-lg cursor-pointer hover:bg-green-300">Edit</button>
							</Link>
							</div>
						<button className="px-1 py-2 text-red-500 border-2 rounded-lg cursor-pointer hover:text-black hover:border-red-500">Delete</button>
                       </div>
				</div>
